...
class DesktopSettingPage extends StatefulWidget {
  ...
  static final List<SettingsTabKey> tabKeys = [
    ...
    //  SettingsTabKey.network,  ağ menüsü
    if (!bind.isIncomingOnly()) SettingsTabKey.display,
    if (!isWeb && !bind.isIncomingOnly() && bind.pluginFeatureIsEnabled())
      SettingsTabKey.plugin,
    //if (!bind.isDisableAccount()) SettingsTabKey.account,  hesap menüsü
    //if (isWindows &&
        ...
        child: _Card(title: translate('About RustDesk'), children: [
          Column(
            ...
            children: [
              ...
              InkWell(
                  onTap: () {
                    launchUrlString('https://rustdesk.com.tr');
                  },
                  child: Text(
              ...
              InkWell(
                  onTap: () {
                    launchUrlString('https://prodev.com.tr');
                  },
                  child: Text(
                    translate('Website'),
                    style: linkStyle,
                  ...
                  children: [
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text(
                            'Copyright © ${DateTime.now().toString().substring(0, 4)} Prodev Yazılım.\n$license',
