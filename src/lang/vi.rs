...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Đang kết nối đến mạng lưới PdRemote..."),
        ...
        ("install_tip", "Do cơ chế UAC, PdRemote có thể không hoạt động ổn định ở phía người dùng từ xa trong một số trường hợp. Để tránh vấn đề này, vui lòng nhấn nút bên dưới để cài đặt PdRemote vào hệ thống."),
        ("Click to upgrade", "Nhấn để nâng cấp"),
        ("Configure", "Cấu hình"),
        ("config_acc", "Để điều khiển từ xa, bạn cần cấp quyền \"Trợ năng\" cho PdRemote."),
        ("config_screen", "Để truy cập từ xa, bạn cần cấp quyền \"Ghi màn hình\" cho PdRemote."),
        ...
        ("android_input_permission_tip2", "Vui lòng tìm [Dịch vụ đã cài đặt] trong cài đặt và bật [PdRemote Input]."),
        ...
        ("Turned off", "Đã tắt"),
        ("Language", "Ngôn ngữ"),
        ("Keep PdRemote background service", "Giữ dịch vụ PdRemote chạy nền"),
        ...
        ("verify_PdRemote_password_tip", "Xác thực mật khẩu PdRemote"),
        ...
        ("scam_text2", "Chỉ sử dụng PdRemote với những người bạn thực sự tin tưởng."),
        ...
        ("upgrade_PdRemote_server_pro_to_{}_tip", "Nâng cấp lên Pro để có thêm tính năng"),
        ...
        ("allow-only-conn-window-open-tip", "Chỉ cho phép khi cửa sổ PdRemote mở"),
        ...
        ("floating_window_tip", "Giữ PdRemote trên cùng"),
        ...
        ("upgrade_remote_PdRemote_client_to_{}_tip", "Vui lòng nâng cấp đối tác lên {}"),
