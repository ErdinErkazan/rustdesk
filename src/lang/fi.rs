...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Yhdistetään PdRemote verkkoon..."),
        ...
        ("install_tip", "Joissain tapauksissa PdRemote ei toimi oikein etäpuolella UAC:n vuoksi. Välttääksesi tämän, napsauta alla olevaa painiketta asentaaksesi PdRemotein järjestelmään."),
        ("Click to upgrade", "Päivitä napsauttamalla"),
        ("Configure", "Määritä"),
        ("config_acc", "Etätyöpöydän hallintaa varten sinun on annettava PdRemoteille ”Esteettömyys”-oikeudet."),
        ("config_screen", "Etätyöpöydän käyttöä varten sinun on annettava PdRemoteille ”Näytön tallennus” oikeudet."),
        ...
        ("Discovered", "Löydetty"),
        ("install_daemon_tip", "Palvelun automaattista käynnistystä varten PdRemote daemon on asennettava järjestelmään."),
        ("Remote ID", "Etätunnus"),
        ("Paste", "Liitä"),
        ...
        ("android_input_permission_tip1", "Siirry Androidin asetuksiin ja ota PdRemoteille käyttöön 'Syötteen ohjaus' oikeus."),
        ("android_input_permission_tip2", "Jos et löydä asetusta, etsi 'Esteettömyys' ja salli PdRemote ohjelman käyttö."),
        ("android_new_connection_tip", "Uusi yhteyspyyntö vastaanotettu."),
        ("android_service_will_start_tip", "PdRemote palvelu käynnistyy taustalla."),
        ("android_stop_service_tip", "Pysäytä taustapalvelu tarvittaessa PdRemotein asetuksista."),
        ("android_version_audio_tip", "Äänensiirto vaatii Android 10:n tai uudemman."),
        ("android_start_service_tip", "PdRemote palvelu käynnistetään..."),
        ...
        ("Language", "Kieli"),
        ("Keep PdRemote background service", "Pidä PdRemotein taustapalvelu käynnissä"),
        ("Ignore Battery Optimizations", "Ohita akun optimoinnit"),
        ("android_open_battery_optimizations_tip", "Poista PdRemotein akkuoptimointi, jotta yhteys pysyy vakaana taustalla."),
        ...
        ("verify_PdRemote_password_tip", "Vahvista PdRemote salasanasi kirjautumista varten"),
        ...
        ("scam_text2", "PdRemote ei koskaan pyydä maksua tai etäkäyttöä ilman lupaasi."),
        ...
        ("upgrade_PdRemote_server_pro_to_{}_tip", "Päivitä PdRemote Server Pro versioon {} jatkaaksesi."),
        ...
        ("About PdRemote", "Tietoa PdRemoteistä"),
        ...
        ("upgrade_remote_PdRemote_client_to_{}_tip", "Päivitä etä-PdRemote-asiakasversioon {} yhteensopivuuden takaamiseksi"),
