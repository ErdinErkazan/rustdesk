...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "PdRemotei võrguga ühendumine..."),
        ...
        ("install_tip", "Kasutajakonto kontrolli (UAC) tõttu ei saa PdRemote mõnel juhul korralikult kaugjuhtimispoolena töötada. Kontrolli vältimiseks palun klõpsa alloleval nupul, et PdRemote oma süsteemi paigaldada."),
        ("Click to upgrade", "Vajuta täiendamiseks"),
        ("Configure", "Seadista"),
        ("config_acc", "Töölaua kaugjuhtimiseks tuleb PdRemoteile anda \"juurdepääsetavuse\" õigused."),
        ("config_screen", "Töölaua kaugjuhtimiseks tuleb PdRemoteile anda \"ekraanisalvestuse\" õigused."),
        ...
        ("android_input_permission_tip1", "Selleks, et kaugseade saaks sinu Androidi seadet juhtida hiire või puute abil, pead andma PdRemoteile \"juurdepääsetavuse\" loa."),
        ("android_input_permission_tip2", "Palun mine järgmisele süsteemiseadete lehele, leia ja sisesta [Paigaldatud teenused], lülita teenus [PdRemote Input] sisse."),
        ...
        ("Language", "Keel"),
        ("Keep PdRemote background service", "Säilita PdRemotei taustateenus"),
        ("Ignore Battery Optimizations", "Ignoreeri akuoptimeerimisi"),
        ("android_open_battery_optimizations_tip", "Kui soovid selle funktsiooni keelata, palun mine järgmisele PdRemotei rakenduse seadete lehele, leia ja sisesta [Aku], eemalda linnuke valikult [Piiramata]"),
        ...
        ("config_input", "Kaugtöölaua klaviatuuriga juhtimiseks pead andma PdRemoteile \"sisendi jälgimise\" õigused."),
        ("config_microphone", "Kaugelt rääkimiseks pead andma PdRemoteile \"heli salvestamise\" õigused."),
        ...
        ("still_click_uac_tip", "Kaugkasutaja peab siiski ise vajutama käitatud PdRemotei kasutajakonto kontrollis (UAC) OK-nuppu."),
        ...
        ("verify_PdRemote_password_tip", "Kinnita PdRemotei parool"),
        ...
        ("scam_text1", "Kui räägid telefoniga kellegagi, keda EI TUNNE ja EI USALDA, kes on palunud sul PdRemotei kasutada ja teenus käivitada, ära jätka ning lõpeta kõne koheselt."),
        ...
        ("upgrade_PdRemote_server_pro_to_{}_tip", "Palun täienda PdRemote Server Pro versioonile {} või uuem!"),
        ...
        ("selinux_tip", "SELinux on su seadmes lubatud, mis võib PdRemoteil takistada juhitud poolel toimimist."),
        ...
        ("powered_by_me", "Põhineb PdRemoteil"),
        ...
        ("allow-only-conn-window-open-tip", "Luba ühendus ainult siis, kui PdRemotei aken on avatud."),
        ...
        ("floating_window_tip", "See aitab säilitada PdRemotei taustateenust."),
        ...
        ("About PdRemote", "PdRemotei teave"),
        ...
        ("upgrade_remote_PdRemote_client_to_{}_tip", "Täiendage PdRemotei klient kaugküljel versioonile {} või uuemale!"),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
