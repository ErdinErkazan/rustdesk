...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Menghubungkan ke PdRemote..."),
        ...
        ("install_tip", "Karena UAC, PdRemote tidak dapat bekerja dengan baik sebagai sisi remote dalam beberapa kasus. Untuk menghindari UAC, silakan klik tombol di bawah ini untuk menginstal PdRemote ke sistem."),
        ("Click to upgrade", "Klik untuk upgrade"),
        ("Configure", "Konfigurasi"),
        ("config_acc", "Agar bisa mengontrol Desktopmu dari jarak jauh, Kamu harus memberikan izin \"Aksesibilitas\" untuk PdRemote."),
        ("config_screen", "Agar bisa mengakses Desktopmu dari jarak jauh, kamu harus memberikan izin \"Perekaman Layar\" untuk PdRemote."),
        ...
        ("android_input_permission_tip1", "Agar perangkat jarak jauh dapat mengontrol perangkat Android melalui mouse atau sentuhan, Kamu harus memberikan izin/permission kd PdRemote untuk menggunakan layanan \"Aksesibilitas\"."),
        ("android_input_permission_tip2", "Silakan buka halaman pengaturan sistem berikutnya, temukan dan masuk ke [Layanan Terinstal], aktifkan layanan [Input PdRemote]."),
        ...
        ("Language", "Bahasa"),
        ("Keep PdRemote background service", "Pertahankan PdRemote berjalan pada service background"),
        ...
        ("Show PdRemote", "Tampilkan PdRemote"),
        ("This PC", "PC ini"),
        ("or", "atau"),
        ("Elevate", "Elevasi"),
        ...
        ("config_input", "Untuk menggunakan input keyboard remote, anda perlu memberikan izin \"Pemantauan Input\" pada PdRemote"),
        ("config_microphone", "Untuk berbicara secara remote, anda perlu memberikan izin \"Rekam Audio\" pada PdRemote"),
        ...
        ("still_click_uac_tip", "Masih memerlukan persetujuan pihak pengguna remote untuk mengklik OK pada jendela UAC PdRemote yang sedang berjalan"),
        ...
        ("verify_PdRemote_password_tip", "Verifikasi Kata Sandi PdRemote"),
        ...
        ("scam_text1", "Jika anda sedang berbicara di telepon dengan seseorang yang TIDAK dikenal dan mereka meminta anda untuk menggunakan PdRemote, jangan lanjutkan dan segera tutup panggilan."),
        ...
        ("upgrade_PdRemote_server_pro_to_{}_tip", "Silahkan perbarui PdRemote Server Pro ke versi {} atau yang lebih baru!"),
        ...
        ("selinux_tip", "pada perangkat anda, SELinux sedang aktif, yang mana itu dapat mencegah PdRemote berfungsi dengan baik sebagai sisi yang dikontrol."),
        ...
        ("powered_by_me", "Didukung oleh PdRemote"),
        ...
        ("allow-only-conn-window-open-tip", "Koneksi hanya diperbolehkan jika jendela PdRemote sedang terbuka."),
        ...
        ("Floating window", ""),
        ("floating_window_tip", "Untuk menjaga layanan/service PdRemote agar tetap aktif"),
        ...
        ("About PdRemote", "Tentang PdRemote"),
        ...
        ("upgrade_remote_PdRemote_client_to_{}_tip", "Silahkan perbarui aplikasi PdRemote ke versi {} atau yang lebih baru pada komputer yang akan terhubung!"),
