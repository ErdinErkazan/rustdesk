...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Website", "Website"),
        ("About", "Hakkında"),
        ("Slogan_tip", "Prodev Yazılım tarafından revize edilmiştir."),
        ...
        ("install_tip", "Kullanıcı Hesabı Denetimi nedeniyle, PdRemote bir uzak masaüstü olarak düzgün çalışmayabilir. Bu sorunu önlemek için, PdRemote'i sistem seviyesinde kurmak için aşağıdaki butona tıklayın."),
        ("Click to upgrade", "Yükseltmek için tıklayınız"),
        ("Configure", "Ayarla"),
        ("config_acc", "Masaüstünüzü dışarıdan kontrol etmek için PdRemote'e \"Erişilebilirlik\""),
        ("config_screen", "Masaüstünüzü dışarıdan kontrol etmek için PdRemote'e \"Ekran Kaydı\" iznini vermeniz gerekir."),
        ...
        ("android_input_permission_tip1", "Uzak bir cihazın Android cihazınızı fare veya dokunma yoluyla kontrol edebilmesi için, PdRemote'in \"Erişilebilirlik\" özelliğini kullanmasına izin vermelisiniz."),
        ("android_input_permission_tip2", "Sonraki sistem ayarları sayfasına gidin, [Yüklü Hizmetler]'i bulun ve erişin, [PdRemote Girişi] hizmetini etkinleştirin."),
        ...
        ("Language", "Dil"),
        ("Keep PdRemote background service", "PdRemote arka plan hizmetini sürdürün"),
        ("Ignore Battery Optimizations", "Pil Optimizasyonlarını Yoksay"),
        ("android_open_battery_optimizations_tip", "Bu özelliği devre dışı bırakmak istiyorsanız lütfen bir sonraki PdRemote uygulama ayarları sayfasına gidin, [Pil] ögesini bulun ve girin, [Sınırsız] ögesinin işaretini kaldırın"),
        ...
        ("Show PdRemote", "PdRemote'i Göster"),
        ("This PC", "Bu PC"),
        ("or", "veya"),
        ("Elevate", "Yükseltme"),
        ...
        ("config_input", "Uzaktaki masaüstünü klavye ile kontrol etmek için PdRemote'e \"Giriş İzleme\" izinleri vermelisiniz."),
        ("config_microphone", "Uzaktan konuşmak için PdRemote'e \"Ses Kaydı\" izinleri vermelisiniz."),
        ...
        ("still_click_uac_tip", "Uzaktaki kullanıcının çalışan PdRemote'in UAC penceresinde hala Tamam'ı tıklaması gerekmektedir."),
        ...
        ("verify_PdRemote_password_tip", "Lütfen Parolayı doğrulayın"),
        ...
        ("scam_text1", "Eğer tanımadığınız ve güvenmediğiniz birisiyle telefonda konuşuyorsanız ve sizden PdRemote'i kullanmanızı ve hizmeti başlatmanızı istiyorsa devam etmeyin ve hemen telefonu kapatın."),
        ...
        ("upgrade_PdRemote_server_pro_to_{}_tip", "Lütfen PdRemote Server Pro'yu {} veya daha yeni bir sürüme yükseltin!"),
        ...
        ("selinux_tip", "Cihazınızda SELinux etkin olduğundan, PdRemote'in kontrollü tarafta düzgün çalışmasını engelleyebilir."),
        ...
        ("powered_by_me", "PdRemote tarafından desteklenmektedir"),
        ...
        ("allow-only-conn-window-open-tip", "Yalnızca PdRemote penceresi açıksa bağlantıya izin ver"),
        ...
        ("floating_window_tip", "PdRemote arka plan hizmetini açık tutmaya yardımcı olur"),
        ...
        ("About PdRemote", "PrdRemote Hakkında"),
        ...
        ("upgrade_remote_PdRemote_client_to_{}_tip", "Lütfen uzak tarafta PdRemote istemcisini {} sürümüne veya daha yenisine güncelleyin!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Varsayılan olarak, PdRemote sunucu sertifikasını TLS kullanarak protokoller için doğrular.\nBu seçenek etkinleştirildiğinde, doğrulama başarısızlığı durumunda PdRemote doğrulama adımını atlayarak işleme devam eder."),
        ("Disable UDP", "UDP'yi devre dışı bırak"),
        ("disable-udp-tip", "Yalnızca TCP kullanılıp kullanılmayacağını kontrol eder.\nBu seçenek etkinleştirildiğinde, PdRemote artık UDP 21116'yı kullanmayacak, bunun yerine TCP 21116 kullanılacaktır."),
        ("server-oss-not-support-tip", "NOT: PdRemote sunucu OSS'si bu özelliği içermemektedir."),
